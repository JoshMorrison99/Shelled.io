...
import ChevronRightIcon from '@mui/icons-material/ChevronRight';
  ...
  const LFI_2_RCE_Proc_Environ = ({ title }: IProps) => {
        ...
        <Accordion sx={{ backgroundColor: "primary.main" }}>
          ...
          >
            ...
            >
              ...
              <a href="https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/File%20Inclusion/README.md#lfi-to-rce-via-procselfenviron" target="_blank">
  ...
  export default LFI_2_RCE_Proc_Environ;
