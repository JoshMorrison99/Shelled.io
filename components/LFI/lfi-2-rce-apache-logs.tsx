...
import ChevronRightIcon from '@mui/icons-material/ChevronRight';
  ...
  const LFI_2_RCE_Apache_Logs = ({ title }: IProps) => {
        ...
        <Accordion sx={{ backgroundColor: "primary.main" }}>
          ...
          >
            ...
            >
              ...
              <a href="https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/File%20Inclusion/README.md#rce-via-apache-logs" target="_blank">
  ...
  export default LFI_2_RCE_Apache_Logs;
